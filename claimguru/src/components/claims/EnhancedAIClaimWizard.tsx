...
// Import enhanced AI wizard step components - DYNAMIC PDF PROCESSING
...
export function EnhancedAIIntakeWizard({ clientId, onComplete, onCancel }: EnhancedAIIntakeWizardProps) {
  ...
  const steps = [
    {
      id: 'policy-upload',
      title: 'Dynamic AI Policy Analysis',
      description: 'Upload different policy documents for unique AI-powered data extraction - no caching',
      icon: FileText,
      component: DynamicPolicyUploadStep,
      required: false
    },
    {
      id: 'client-details',
