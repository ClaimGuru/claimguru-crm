              ...
              <div className="space-y-4">
                <AddressAutocomplete
                  ...
                  onChange={(address, details) => {
                    console.log('🏢 Manual Agent Address Selected:', { address, details })
                    
                    if (details?.address_components) {
                      const components = details.address_components;
                      console.log('📍 Manual Address Components:', components)
                      ...
                      console.log('📊 Manual Parsed Address Components:', { fullStreet, city, state, zipCode })
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          {deductibles.map((deductible) => (
            <div key={deductible.id} className="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden">
                    ...
                    {deductible.isPercentage && deductible.calculatedAmount && (
                      <div className="bg-green-100 rounded-lg p-3">
                        ...
                        <div className="text-xl font-bold text-green-900">
                          ${deductible.calculatedAmount.toLocaleString()}
                        </div>
                ...
                <div className="bg-purple-50 rounded-lg p-4">
                  ...
                  <div className="space-y-3">
                    ...
                    >
                      ...
                      <option value="Yes">✓ Yes - Apply this deductible</option>
                    ...
                    {deductible.appliesTo === 'Yes' && (
                      <div className="bg-green-100 border border-green-300 rounded-lg p-3">
                        <div className="flex items-center gap-2 text-green-800">
                          ...
                          <span className="font-semibold">Active Deductible</span>
                        </div>
                        <p className="text-sm text-green-700 mt-1">
                          This deductible will be applied to the current claim calculations
                        </p>
                      </div>
                    )}
                  </div>
