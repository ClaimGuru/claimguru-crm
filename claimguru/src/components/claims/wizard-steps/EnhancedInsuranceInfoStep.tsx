...
export const EnhancedInsuranceInfoStep: React.FC<EnhancedInsuranceInfoStepProps> = ({
  ...
  }, [insuranceCarrier, policyDetails, coverages, deductibles, priorPayments, isForcedPlaced, deductRecoverableDepreciation])
            ...
            <div key={deductible.id} className="flex items-center gap-4 p-3 border rounded-lg">
              ...
              <label className="flex items-center gap-3">
                <Switch
                  ...
                  onChange={(checked) => updateDeductible(deductible.id, 'isPercentage', checked)}
                />
