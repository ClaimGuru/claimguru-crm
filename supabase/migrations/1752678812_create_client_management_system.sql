...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_client_records_organization_id ON client_records(organization_id);
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_client_records_client_number ON client_records(client_number);
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_client_records_primary_email ON client_records(primary_email);
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_client_records_status ON client_records(client_status);
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_client_records_created_at ON client_records(created_at);

CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_leads_organization_id ON leads(organization_id);
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_leads_lead_number ON leads(lead_number);
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_leads_lead_source_id ON leads(lead_source_id);

CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_user_permissions_user_id ON user_permissions(user_id);
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_user_permissions_organization_id ON user_permissions(organization_id);

CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_client_permissions_client_id ON client_permissions(client_id);
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_client_permissions_user_id ON client_permissions(user_id);
