-- Migration: seed_crm_entity_data
-- Created at: 1755287756

-- Migration: Seed CRM Entity Management System Data
...
(VALUES 
    ...
    ('Drywall', 'DRYWALL', 'Drywall installation and repair', ARRAY[]),
    ('Painting', 'PAINTING', 'Interior and exterior painting services', ARRAY[]),
    ('Windows & Doors', 'WINDOWS_DOORS', 'Window and door installation and repair', ARRAY[])
